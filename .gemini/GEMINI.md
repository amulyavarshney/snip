...
Test infrastructure (fixtures, helpers, shared setup) that must not be deleted
is tagged `// snip:safe — <reason>`. The tag protects test scaffolding from
rung-0 deletion — it exists to prevent false confidence, not bloat.
